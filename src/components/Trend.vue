<template>
    <div
      class="bg-[#202127] h-auto w-full rounded-2xl flex mt-2 p-5 text-xl text-white"
    >
    <div class="space-y-5">
      <div class="font-extrabold text-xl ">Trends for you</div>
      <Tr upper="Trending in the Philippines" middle="#SHKiller" lower="9,895 posts"/>
      <Tr upper="Music · Trending" middle="GUSTO NA KITA EH" lower="8,924 posts"/>
